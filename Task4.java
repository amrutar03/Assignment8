...
public class Task4 {
	...
	public static void main(String[] args) throws InterruptedException {
	    ...
	    firstname.sendKeys("smriuta");
	    WebElement lastname=driver.findElement(By.xpath("input[name='lastname']"));
	    lastname.sendKeys("smriuta"); 
	   ...
	   WebElement pwd=driver.findElement(By.xpath("input[id='password_step_input']"));
	    ...
	    Thread.sleep(2000);
	    WebElement dropdownElement2 = driver.findElement(By.xpath("#month"));
	    if(!dropdownElement2.isSelected())
	    {
	    ...
	    WebElement radioBtn=driver.findElement(By.xpath("label[for='u_3_4_f4']")); 
